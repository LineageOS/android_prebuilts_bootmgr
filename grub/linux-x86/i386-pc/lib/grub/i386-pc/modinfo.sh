...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Debian 12.2.0-14+deb12u1) 12.2.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/12/include -I$(top_srcdir)/include -I$(top_builddir)/include'
